  ...
  <div class="flex justify-center align-center">
    <div class="bg-white dark:bg-gray-800 py-8 px-4 sm:px-10">
      ...
      <div class="mt-6">
        ...
        <span class="block w-full rounded-md shadow-sm pt-2">
          <push-button theme="indigo" class="w-full justify-center" @click="loginWithEmail">
...
function handleMessage (event: { data: models.OauthResult }): void {
